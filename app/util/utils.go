...
func IsEmpty(params interface{}) bool {
	...
	//由于params 接口类型 所以defaultValue也要获取对应接口类型的值 如果获取不为接口类型 一直为返回false
...
// JwtEncode jwt加密
func JwtEncode(jwtinfo jwt.MapClaims, secretKey []byte) (jwtToken string, err error) {
...
// JwtDncode jwt解密
func JwtDncode(tokenString string, secretKey interface{}) (tokenInfo map[string]interface{}, err error) {
